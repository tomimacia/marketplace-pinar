      ...
      {user && !loading && (
        <Menu>
          ...
          <MenuList zIndex={15}>
            ...
            <Link href="/clientPages/miCuenta" as="cliente/mi-cuenta">
              <MenuItem _hover={{ bg: "blue.200", borderRadius: "10px" }}>
                Mi Cuenta
              </MenuItem>
            </Link>
            <Link href="/clientPages/configuracion" as="cliente/ajustes">
              <MenuItem _hover={{ bg: "blue.200", borderRadius: "10px" }}>
                Ajustes
              </MenuItem>
            </Link>
            <Link
              ...
              as="cliente/favoritos"
            >
              <MenuItem _hover={{ bg: "blue.200", borderRadius: "10px" }}>
                Favoritos
              </MenuItem>
            </Link>
            <Link href="/clientPages/misCompras" as="cliente/mis-compras">
              <MenuItem _hover={{ bg: "blue.200", borderRadius: "10px" }}>
                Mis Compras
              </MenuItem>
            </Link>
