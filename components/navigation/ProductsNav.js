    ...
    <Flex>
      <Menu>
        ...
        <MenuList zIndex={15} width="40vw">
          <Link href="/productPages/productInterface?categoria=Deportes" as='products-interface/deportes'>
            <MenuItem _hover={{bg:'#aaa', borderRadius: '10px'}}>Deportes</MenuItem>
          </Link>
          <Link href="/productPages/productInterface?categoria=Herramientas" as='products-interface/herramientas'>
            <MenuItem _hover={{bg:'#aaa', borderRadius: '10px'}}>Herramientas</MenuItem>
          </Link>
          <Link href="/productPages/productInterface?categoria=Inmuebles" as='products-interface/inmuebles'>
            <MenuItem _hover={{bg:'#aaa', borderRadius: '10px'}}>Inmuebles</MenuItem>
          </Link>
          <Link href="/productPages/productInterface?categoria=Tecnologia" as='products-interface/tecnologia'>
            <MenuItem _hover={{bg:'#aaa', borderRadius: '10px'}}>Tecnologia</MenuItem>
          </Link>
          <Link href="/productPages/productInterface?categoria=Supermercado" as='products-interface/supermercado'>
            <MenuItem _hover={{bg:'#aaa', borderRadius: '10px'}}>Supermercado</MenuItem>
          </Link>
          <Link href="/productPages/productInterface?categoria=Vehiculos" as='products-interface/vehiculos'>
